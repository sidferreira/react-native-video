...
@interface RCTVideoGoogleIMA () <IMAAdsLoaderDelegate, IMAStreamManagerDelegate, IMAAVPlayerVideoDisplayDelegate>
...
@implementation RCTVideoGoogleIMA

- (instancetype)initWithRCTVideo: (RCTVideo *) rctVideo
{
    NSLog(@"IMA >>> initWidthRCTVideo");
    if ((self = [super init])) {
        _rctVideo = rctVideo;
        [self setupAdsLoader];
    }
